...
class VGGNet(MetaModule):
    def __init__(self, n_out):
        super(VGGNet, self).__init__()

        self.features = nn.Sequential(
            MetaConv2d(1, 64, kernel_size=3, padding=1),
            ...
            MetaConv2d(256, 512, kernel_size=3, padding=1),
            nn.ReLU(inplace=True),
            MetaConv2d(512, 512, kernel_size=3, padding=1),
            nn.ReLU(inplace=True),
            nn.MaxPool2d(kernel_size=2, stride=2),
        ...
        self.classifier = nn.Sequential(
            MetaLinear(25088, 4096),
            nn.ReLU(inplace=True),
            MetaLinear(4096, 4096),
            nn.ReLU(inplace=True),
            MetaLinear(4096, n_out),
        )
